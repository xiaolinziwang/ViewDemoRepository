...
public class MainActivity extends AppCompatActivity {
    ...
    private static long ONE_HOUR = 86400000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv_write_calender).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view1) {
                ...
                //}
                View customView = LayoutInflater.from(context).inflate(R.layout.view_toast, null);
                customView.setBackgroundResource(R.drawable.bg_toast_black);
                TextView tvToast = customView.findViewById(R.id.tv_toast);
                tvToast.setText("aaaaaaa");
                ...
                //                Manifest.permission.READ_CALENDAR }, 101);
                //        return;
                //    }
                //}
                //
                //if (checkAndAddCalendarAccount(getApplicationContext()) != -1) {
                //    addEvent();
                //} else {
                //    Toast.makeText(getApplicationContext(), "不存在账户", Toast.LENGTH_LONG).show();
                //}
            }
        });
    }
    ...
    private void addEvent() {
        String title = "上课啦";
        deleteCalendarEvent(getApplicationContext(), title);
        addCalendarEvent(getApplicationContext(), title, "今天上英语啦，上课链接https://www.baidu.com",
    ...
    public void deleteCalendarEvent(Context context, String title) {
        ...
        try {
            ...
            if (eventCursor.getCount() > 0) {
                ...
                for (eventCursor.moveToFirst(); !eventCursor.isAfterLast();
                    ...
                    if (!TextUtils.isEmpty(title) && title.equals(eventTitle)) {
                        ...
                        Uri deleteUri = ContentUris
                                .withAppendedId(Uri.parse(CALANDER_EVENT_URL), id);
    ...
    /**
     * 备注人：chunlinwang
     * 备注时间：2019/5/15 下午2:14
     * 备注：检查是否有现有存在的账户。存在则返回账户id，否则返回-1
     */
